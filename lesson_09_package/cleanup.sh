#!/usr/bin/env bash
# Day 9 - cleanup.sh: stop services/containers and remove unused Docker resources.
set -euo pipefail
...
echo ""
echo "== Searching and removing project artifacts =="
...
echo ""
echo "== Stopping and removing Day 9 containers =="
