#!/usr/bin/env bash
# Day 1 - start.sh: install deps, build, run, test, verify.
set -e
...
if command -v docker &> /dev/null; then
    docker build -t day1-pipeline . --quiet && echo "Docker image built: day1-pipeline"
else
...
echo ""
echo "== Verify =="
echo "If you see 'Final:' output above and all tests passed, Day 1 is verified."
